    ...
    const code = `var style = new HelpProviderStyle()
{
  ...
  return (
    <div className="flex h-screen w-full bg-[#1e1e1e] text-gray-300 font-mono text-sm overflow-hidden">
      ...
      <div className="w-1/2 h-full overflow-y-auto bg-[#0c0c0c] p-6 text-gray-200">
      ...
      {activeEditor && (
        <div 
          ref={editorRef}
          className="fixed bg-[#252526] border border-[#454545] rounded-md shadow-2xl p-4 w-72 z-50 flex flex-col gap-4 font-sans"
          style={{ 
